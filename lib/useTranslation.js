...
export function useTranslation(namespace = 'common', initialTranslations = null) {
    const router = useRouter();
    const locale = router.locale || 'fr';
    const [translations, setTranslations] = useState(initialTranslations || {});

    useEffect(() => {
        // Si on a déjà les traductions initiales, on ne fait rien
    ...
    }, [locale, namespace, initialTranslations]);
